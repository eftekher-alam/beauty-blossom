        ...
        <div>
            ...
            >
                <div className="card-body">
                    <h2 className="card-title mx-auto font-light tracking-widest text-3xl">ADD PRODUCT</h2>
                    <hr />
                    <form onSubmit={handlerAddProduct}>
                        ...
                        <div className="flex gap-4 md:gap-8 pb-4 max-md:flex-col">
                            <div className="form-control w-full  ">
                                ...
                                <input type="text" name="ProductName" placeholder="Product name here..." className="input input-bordered w-full" required />
                            </div>
                            <div className="form-control w-full  ">
                                <label className="label">
                                ...
                                <select className="select select-bordered" name="BrandName">
                                    <option selected>Pick a brand name</option>
                                    {
                        ...
                        <div className="flex gap-8 pb-4">
                            <div className="form-control w-full  ">
                                ...
                                <input type="number" name="Price" placeholder="Price here..." className="input input-bordered w-full  " required />
                            </div>
                            <div className="form-control w-full  ">
                                <label className="label">
                                    <span className="label-text">Rating</span>
                                </label>
                                <input type="number" name="Rating" placeholder="Rating here..." className="input input-bordered w-full  " />
                            </div>
                        ...
                        <div className="flex gap-8 w-full pb-4">
                            <div className="form-control w-full">
                                ...
                                <input type="text" name="Photo" placeholder="www.photo.com/coffee-photo" className="input input-bordered w-full" required />
                            </div>
                        </div>
